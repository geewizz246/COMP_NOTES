/* A program is required to read the name and the marks earned in 4 tests for a series of students terminated by n. 
	a) Determine the average mark for each student and write this information to a txt file called student marks. For each mark put the subject next to it.
	b)  i) Read the contents of your file and print all the information entered to the screen (with labels…duh!).
	   ii) Determine the max and min average as well as the student who earned this.
	  iii) Allow the user to enter a student name and search the file for the student record and print this to the screen */
