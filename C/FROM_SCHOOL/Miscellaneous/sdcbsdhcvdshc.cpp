...
/*The two aformentioned functions WILL NOT WORK when a scanf is used just prior as they take the newline character as their input, leaving no room for the user to input anything*/
...
printf("============================================================\n\n\n");
	...
	if(drug.ID==identification)/*drug was found*/
	{
		stockFormat();/*call to function stockFormat*/
...
printf("============================================================\n\n\n\n");
	...
	{  
		...
		{
			queueFormat();/*call to function queueFormat*/
		}/*end if*/		
	}/*end while*/
...
printf("===========================================================\n\n\n\n");
	...
	{   
		...
		if(order.ID!=0)
		{
			orderFormat();/*call to function orderFormat*/
		}/*end if*/
	}/*end while*/
...
void enqueueOrder()
{
	...
	{
		indexs=indexs;/*determines position to write the entered record into file*/
...
enqueueOrder();/*call to function enqueueOrder*/
...
printf("\n\n!!ERROR 0090!! Invalid answer!\n");
				...
				if(stricmp(confirmOrder,"yes")==0)//YES
				{
					printf("\n\n\nPrinting your bill........\n\n\n");
					queueFormat();/*call to function queueFormat*/
					dequeueOrder();/*call to function dequeueOrder*/
				}/*end if*/
