...
int main() {
    ...
    std::cout << "Fraction 1 numerator is " << f1.getNumerator()
        << ", denominator is " << f1.getDenominator()
        << " and its double equivalent is " << f1.toDouble() << ".\n";
    std::cout << "Fraction 2 numerator is " << f2.getNumerator()
        << " and denominator is " << f2.getDenominator()
